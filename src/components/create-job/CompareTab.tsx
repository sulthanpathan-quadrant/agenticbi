...
// const FULL_DATA_URL =
//   'https://api.veriton.ai/api/service3//data_full'

// const TASK_FEATURES_API =
//   'https://api.veriton.ai/api/service3//task_features'
...
//       const toastId = toast.loading(`Analyzing dataset for ${selectedTask} targets...`)
...
//         const url = `${TASK_FEATURES_API}?blob_path=${encodeURIComponent(blobPath)}&task=${taskParam}&user_email=${encodeURIComponent(userEmail)}`
...
//       <main className="pt-20 px-8 pb-16 max-w-[1400px] mx-auto">
//         {/* Back button + title */}
...
//           <Button
//             variant="outline"
//             onClick={() => navigate('/workflow/automl/build-model', { state: { dataset } })}
//           >
//             Build a Model
//           </Button>
//             <button
...
//               >
//                 <SelectTrigger className="bg-background">
//                   <SelectValue placeholder={selectedTask ? 'Select Model 1' : 'Select task first'} />
//                 </SelectTrigger>
//                 <SelectContent>
//                   {availableModels.map(m => (
//                     <SelectItem key={m} value={m} disabled={m === selectedModel2}>
//                       {m}
//                     </SelectItem>
//                   ))}
//                 </SelectContent>
...
//               >
//                 <SelectTrigger className="bg-background">
//                   <SelectValue placeholder={selectedTask ? 'Select Model 2' : 'Select task first'} />
//                 </SelectTrigger>
//                 <SelectContent>
//                   {availableModels.map(m => (
//                     <SelectItem key={m} value={m} disabled={m === selectedModel1}>
//                       {m}
//                     </SelectItem>
//                   ))}
//                 </SelectContent>
...
//                   {isFetchingFeatures ? (
//                     <div className="px-3 py-2 text-sm text-muted-foreground">Loading targets...</div>
