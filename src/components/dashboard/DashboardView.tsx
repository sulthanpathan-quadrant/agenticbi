...
// import { ArrowLeft, Download, Share2, BarChart3, TrendingUp, FileText, MessageSquare } from 'lucide-react';
...
//         {/* Info Bar - Source with Actions on right */}
...
//           <span className="px-3 py-1.5 rounded-full bg-primary/10 text-primary font-medium">4 KPIs</span>
//           <span className="px-3 py-1.5 rounded-full bg-emerald-500/10 text-emerald-400 font-medium">6 Months Data</span>
//           <span className="px-3 py-1.5 rounded-full bg-amber-500/10 text-amber-400 font-medium">5 Categories</span>
//           <span className="px-3 py-1.5 rounded-full bg-violet-500/10 text-violet-400 font-medium">5 Regions</span>
//         </div>
...
//             <span className="text-sm font-medium text-foreground">Key Performance Indicators</span>
//           </div>
...
//           <SalesTrendChart data={data.lineChartData} />
//           <CategoryPieChart data={data.pieChartData} />
//         </div>

//         {/* Charts Row 2 */}
//         <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 animate-slide-up" style={{ animationDelay: '300ms' }}>
//           <ProductTable data={data.tableData} />
//           <RegionBarChart data={data.barChartData} />
//         </div>
//       </div>
