...
// import { FileText, Table, FileJson, Search } from 'lucide-react';
...
// export function DatasetSidebar({ files, selectedFile, onSelectFile }: DatasetSidebarProps) {
...
//                     {file.rows.toLocaleString()} rows • {file.columns} cols
//                   </p>
//                 </div>
//                 {isSelected && (
