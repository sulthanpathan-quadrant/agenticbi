...
// Extracted so it can be re-invoked (e.g. after a new dataset is uploaded via chat)
  const loadDatasets = async (autoSelectFirst = true) => {
    setDsLoading(true);
  ...
  return (
    <div className="min-h-screen h-screen bg-background flex flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-hidden">
        ...
        {/* Chatbot */}
        {/* Chatbot */}
        <Chatbot onDatasetUploaded={() => loadDatasets(false)} />
      </div>
    </div>
  );
};
