...
//         {Object.entries(allModelsFromResults || {}).map(([modelName, modelData]: [string, any]) => (
//           <motion.div
//             key={modelName}
//             initial={{ opacity: 0, y: 20 }}
//             animate={{ opacity: 1, y: 0 }}
...
//                         <th key={metric.key} className="text-center py-3 font-medium">
//                           {metric.label}
//                         </th>
//                       ))}
//                     </tr>
...
//                           {fmt(modelData?.train?.[metric.key], metric.key.includes("mape"))}
//                         </td>
//                       ))}
//                     </tr>
//                     <tr>
...
//                       {metricSpecs.map((metric) => (
//                         <td key={metric.key} className="text-center py-4">
//                           {fmt(modelData?.test?.[metric.key], metric.key.includes("mape"))}
//                         </td>
//                       ))}
//                     </tr>
//                   </tbody>
...
//         >
//           <h2 className="text-2xl font-semibold mb-5">Analysis Summary</h2>
//           <div className="prose prose-neutral dark:prose-invert max-w-none text-base leading-relaxed">
//             <ReactMarkdown>{buildData.analysis}</ReactMarkdown>
//           </div>
//         </motion.section>
//       )}
...
//         >
//           <h2 className="text-2xl font-semibold mb-5">Next Steps & Suggestions</h2>
