...
//   // Transform into the new required format
//   const column_mappings = Object.entries(columnMappingsByTable).map(([originalTableName, columns]) => ({
//     source_name: `${userId}_${jobId}_${originalTableName}`,
//     source_type: "table",           // default value as per new spec
//     columns,
//   }));
...
//     custom_table_name: customTableName.trim(),
//     column_mappings,
//     join_type: "INNER"              // default value as requested
//   };
...
//     // ────────────────────────────────────────────────
//     // Transfer call (kept as non-blocking / fire-and-forget)
//     // ────────────────────────────────────────────────
//     try {
//       const transferResponse = await fetch(
//         `https://api.veriton.ai/api/service2/transferfromonelaketoblob?user_id=${userId}&job_id=${jobId}`,
