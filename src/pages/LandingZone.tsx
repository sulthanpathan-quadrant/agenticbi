...
//         throw new Error(`Fact/Dimension detection failed: ${errorText}`);
//       }

//       // 2. Transfer to OneLake
...
//         throw new Error(`Transfer to OneLake failed: ${errorText}`);
//       }

//       toast.dismiss("modeling-progress");
//       toast.success("Preparation completed successfully!");

//       // Navigate only when both APIs succeed
