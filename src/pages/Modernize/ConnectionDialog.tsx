...
/*
 * ---------------------------------------------------------------
 * DEMO DEFAULTS — hardcoded placeholders
 * ---------------------------------------------------------------
 * These are placeholder values only (passwords are intentionally
 * left out — those still need to be typed in each time). Swap the
 * placeholder strings below for your real host/database/username
