...
//   // Fetch job names once so we can show real names in modal
//   useEffect(() => {
//     const fetchJobNames = async () => {
//       try {
//         const res = await fetch(`${API_BASE}/get-all-jobs?user_id=${userId}`, {
//           method: "GET",
//           headers: {
//             "Content-Type": "application/json",
//           },
...
//         if (!res.ok) {
//           console.warn("Could not load job names:", res.status);
//           return;
//         }
...
//           const id = job.job_id;
//           const name = job.job_name || "Unnamed Job";
...
//         setJobNameMap(map);
//       } catch (err) {
//         console.warn("Failed to load job names for modal:", err);
//       }
//     };
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="flex items-center gap-6">
              ...
              <button onClick={() => navigate("/pipelines")} className="flex items-center gap-2 text-primary font-medium border-b-2 border-primary pb-1">
