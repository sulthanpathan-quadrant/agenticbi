...
//   );
// }
//   // Check if it's a custom dashboard (from chatbot) or recommended dashboard
//   const isCustomDashboard = !dashboardData.kpis; // Custom dashboards don't have 'kpis' field
